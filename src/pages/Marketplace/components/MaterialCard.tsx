...
import { Material } from "@/hooks/queries/useMaterials";
...
const MaterialCard = ({ material }: MaterialCardProps) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md flex gap-6">
      <img
        src={material.image || GoldImage}
        alt={material.material_name || "Material"}
